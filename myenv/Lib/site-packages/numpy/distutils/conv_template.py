...
.i or .c or .h, using the following templates rules
...
Example:
    ...
    produces
        ...
        line 1 "templates.c.src"

        /*
         *********************************************************************
         **       This file was autogenerated from a templates  DO NOT EDIT!!**
...
def parse_loop_header(loophead) :
    ...
    # generate list of dictionaries, one for each templates iteration
    dlist = []
    if nsub is None :
