...
class ErrorTypeInfo(_TypedDict):
    ...
    """String templates to render a human readable error message from using context, when the input is Python."""
    ...
    """String templates to render a human readable error message from using context, when the input is JSON data."""
