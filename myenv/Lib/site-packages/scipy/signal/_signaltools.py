...
def correlate2d(in1, in2, mode='full', boundary='fill', fillvalue=0):
    ...
    Examples
    --------
    Use 2D cross-correlation to find the location of a templates in a noisy
    image:
    ...
    >>> templates = np.copy(face[300:365, 670:750])  # right eye
    >>> templates -= templates.mean()
    >>> face = face + rng.standard_normal(face.shape) * 50  # add noise
    >>> corr = signal.correlate2d(face, templates, boundary='symm', mode='same')
    ...
    >>> ax_orig.set_title('Original')
    >>> ax_orig.set_axis_off()
    >>> ax_template.imshow(templates, cmap='gray')
