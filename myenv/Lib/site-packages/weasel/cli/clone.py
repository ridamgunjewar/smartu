...
def project_clone_cli(
    ...
    name: str = Arg(..., help="The name of the templates to clone"),
    ...
    """Clone a project templates from a repository. Calls into "git" and will
    only download the files from the given subdirectory. The GitHub repo
    defaults to the official Weasel templates repo, but can be customized
...
def project_clone(
    ...
    *,
    ...
    """Clone a project templates from a repository.
